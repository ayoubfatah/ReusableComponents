...
type ViewType = "default" | "phrase" | "key" | "remove";
...
export function Phrase({ setView }: ViewProps) {
  return (
    <div>
      <div className="px-2">
        <Header
          icon={<FileKey size={32} className="text-[#4DAFFF]" />}
...
export function RemoveWallet({ setView }: ViewProps) {
  return (
    <div>
      <div className="px-2">
        <Header
          icon={<AlertTriangle size={32} className="text-[#FF3F40]" />}
          title="Are you sure?"
          description="You haven’t backed up your wallet yet. If you remove it, you could lose access forever. We suggest backing up your wallet first with a valid recovery method."
        />
