...
export default function Page() {
  ...
  return (
    <main className={cn('w-screen', 'h-screen', 'bg-black', 'text-white')}>
      <MultiLayerParallax />
      <div className={cn('w-full', 'bg-[#06141D]')}>
        <div className={cn('max-w-lg', 'space-y-4', 'mx-auto', 'py-24', 'text-neutral-300')}>
          <p>
